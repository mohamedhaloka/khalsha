  ...
  void onInit() {
    ...
    slides = const <OnBoardingItemModel>[
      ...
      OnBoardingItemModel(
        ...
        title: 'خلصها وأكثر ..',
        subTitle:
            '''أنت لا تحتاج الى فريق متكامل فهنا في منصة خلصها و بغضون دقائق معدودة وبأقل جهد تستطيع ارسال الطلب الخاص بك بطريقة محترفة وسهلة ومن ثم الحصول على عروض أسعار مصممة خصيصاً لك لملائمة متطلباتك واحتياجاتك.''',
      ),
      OnBoardingItemModel(
        image: '3',
        title: 'ابحث .. وفر .. قارن',
