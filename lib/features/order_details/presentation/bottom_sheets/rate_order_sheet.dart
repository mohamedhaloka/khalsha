            ...
            child: ListView(
              children: [
                Container(
                  ...
                  child: Text(
                    'نتمنى انك حصلت على تجربة رائعة فى هذا الطلب، يمكنك ان تضع تقييمك ل (${widget.user?.name}) وأضافة رأيك بكل حيادية ليعرف الاخرين مدي مصداقية التعامل التى مررت بها.',
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: RatingBar.builder(
                      ...
                      onRatingUpdate: (double newRate) => rate = newRate,
                    ),
                  ),
                ),
                CustomTextField.withBorder(
                  title: 'عطنا رأيك بالخدمة؟',
                  maxLines: 4,
                  radius: radius,
