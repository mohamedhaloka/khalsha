...
class _PricingOfferDetailsSheetState extends State<PricingOfferDetailsSheet> {
  ...
  bool get _noActionYet =>
      widget.offer.acceptedAt == null && widget.offer.rejectedAt == null;
            ...
            child: ListView(
              children: [
                ...
                Padding(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Text(
                        'إجمالي السعر ${widget.offer.total!} ${'riyal_saudi'.tr}',
                ...
                ListTile(
                  ...
                  subtitle: const Text('الإطلاع على عرض السعر'),
                  trailing: const Icon(
                            ...
                            recognizer: TapGestureRecognizer()
                              ..onTap = () {
                                final Uri url = Uri.parse(
                                    'https://khlasha.com/terms/and/Conditions');
                                launchUrl(
                                  url,
